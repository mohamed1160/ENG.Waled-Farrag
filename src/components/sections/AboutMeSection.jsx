...
export default function AboutSection() {
    ...
    return (
        <section ref={sectionRef} id="about" className="w-full bg-black text-white pt-20 px-6 md:mt-10 md:px-10 lg:px-16">
            <div className="flex flex-col md:flex-row items-start gap-8 lg:gap-10">
                ...
                <div
                    ...
                    <div>
                        <h2
                            className={`
                                text-[26px] md:text-[32px] lg:text-[48px] font-semibold mb-4
                        ...
                        <p
                            className={`
                                font-light text-[var(--secondary-1)] text-[16px] md:text-[18px] lg:text-[24px] mb-6
